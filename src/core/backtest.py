...
from src.core.probability import calcular_ev
from src.core.model import preparar_dataset, split_temporal, FEATURES, MAPPING
from src.services.bankroll import kelly
