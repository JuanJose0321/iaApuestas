...
class DataSourceManager:
    ...
    def _ctx_api(self, home: str, away: str) -> dict:
        ...
        from src.providers.api_football import contexto_partido_completo as _fn
    ...
    def _ctx_sm(self, home: str, away: str) -> dict:
        ...
        from src.providers.sportsmonk import contexto_partido_completo as _fn
    ...
    def _ctx_tsdb(self, home: str, away: str) -> dict:
        ...
        from src.providers.thesportsdb import contexto_partido_completo as _fn
    ...
    def _ctx_auto(self, home: str, away: str) -> dict:
        ...
        from src.providers.sportsmonk import disponible as _sm_disponible
        if _sm_disponible():
    ...
    def factor_ajuste_lesiones(self, injuries: list) -> float:
        ...
        from src.providers.api_football import factor_ajuste_lesiones as _fn
        return _fn(injuries)

    def get_fixtures_today(self, league_id: int | None = None) -> list:
        """Partidos del día (solo api-football dispone de este endpoint)."""
        from src.providers.api_football import get_fixtures_today as _fn
    ...
    def get_fixture_result(self, fixture_id: int) -> dict | None:
        ...
        from src.providers.api_football import get_fixture_result as _fn
    ...
    def get_team_form(self, team_name: str, last: int = 5,
        ...
        if fuente in ("api-football", "auto"):
            from src.providers.api_football import search_team, get_team_form as _fn_api
        ...
        if fuente in ("sportsmonk", "auto"):
            from src.providers.sportsmonk import disponible as _sm_disponible, search_team as _sm_search
            from src.providers.sportsmonk import get_team_form as _fn_sm
            if _sm_disponible():
        ...
        from src.providers.football_csv import get_team_form_csv
    ...
    def get_h2h(self, home: str, away: str, last: int = 10,
        ...
        if fuente in ("api-football", "auto"):
            from src.providers.api_football import search_team, get_head_to_head as _fn_api
        ...
        if fuente in ("sportsmonk", "auto"):
            from src.providers.sportsmonk import disponible as _sm_disponible, search_team as _sm_search
            from src.providers.sportsmonk import get_head_to_head as _fn_sm
            if _sm_disponible():
        ...
        from src.providers.football_csv import get_h2h_csv
    ...
    def thesportsdb_fixtures_hoy(self, league_id: str = "4350") -> list:
        ...
        from src.providers.thesportsdb import get_fixtures_today
        try:
